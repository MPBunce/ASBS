...
import { useGetAllPhysiotherapistsMutation, useGetAllPatientsMutation, useUserDeleteAppointmentMutation } from '../../slices/userApiSlice';
import { setPatients, updatePatient } from '../../slices/patientSlice';
...
const HomeScreen = () => {
    ...
    const [deleteAppointment, {isLoadingDeleteAppointment}] = useUserDeleteAppointmentMutation();
    ...
    const handleDelete = async (id) => {
        ...
        try {
            var data = id 
            const res = await deleteAppointment(data).unwrap()
                                ...
                                <div key={appointment.appointmentId} className="card my-2">
                                    <div className="card-body">
                                        ...
                                        <div className="row mx-md-n5 justify-content-between">
                                            ...
                                            <div className="col-2">
                                                <Button className="btn-danger" onClick={ () => handleDelete(appointment.appointmentId)}>Delete</Button>
                                            </div>
                                        </div>
